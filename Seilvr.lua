List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Seilvr.."Seilvr:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(Seilvr..'Seilvr:'..v..text)
end
Redis:del(Seilvr.."Seilvr:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Seilvr.."Seilvr:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(Seilvr.."Seilvr:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Seilvr.."Seilvr:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Seilvr.."Seilvr:ChekBotAdd") 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Seilvr.."Seilvr:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Seilvr.."Seilvr:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Seilvr.."Seilvr:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Seilvr.."Seilvr:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه بالتوجيه خاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Seilvr.."Seilvr:Num:User:Pv")   
LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم التوجيه الى *- "..#list.." * مجموعه في البوت ","md",true) 
for k,v in pairs(list) do  
...
if text and Redis:get(Seilvr..'Seilvr:GetTexting:DevSeilvr'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(Seilvr..'Seilvr:GetTexting:DevSeilvr'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم الغاء حفظ كليشة المطور')
end
Redis:set(Seilvr..'Seilvr:Texting:DevSeilvr',text)
Redis:del(Seilvr..'Seilvr:GetTexting:DevSeilvr'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم حفظ كليشة المطور')
end
if Redis:get(Seilvr.."Seilvr:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Seilvr.."Seilvr:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Seilvr.."Seilvr:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Seilvr.."Seilvr:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم تعين الايدي عام',"md",true)  
end
if Redis:get(Seilvr.."Seilvr:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(Seilvr.."Seilvr:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Seilvr.."Seilvr:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Seilvr.."Seilvr:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Seilvr.."Seilvr:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Seilvr.."Seilvr:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Seilvr.."Seilvr:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Seilvr.."Seilvr:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︙ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Seilvr.."Seilvr:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Seilvr.."Seilvr:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Seilvr.."Seilvr:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Seilvr.."Seilvr:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Seilvr.."Seilvr:Game:Smile"..msg.chat_id) then
if text == Redis:get(Seilvr.."Seilvr:Game:Smile"..msg.chat_id) then
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Seilvr.."Seilvr:Game:Smile"..msg.chat_id)
...
if Redis:get(Seilvr.."Seilvr:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Seilvr.."Seilvr:Game:Monotonous"..msg.chat_id) then
Redis:del(Seilvr.."Seilvr:Game:Monotonous"..msg.chat_id)
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Seilvr.."Seilvr:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Seilvr.."Seilvr:Game:Riddles"..msg.chat_id) then
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Seilvr.."Seilvr:Game:Riddles"..msg.chat_id)
...
if Redis:get(Seilvr.."Seilvr:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Seilvr.."Seilvr:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Seilvr.."Seilvr:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Seilvr.."Seilvr:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Seilvr.."Seilvr:Game:Reflection"..msg.chat_id) then
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Seilvr.."Seilvr:Game:Reflection"..msg.chat_id)
...
if Redis:get(Seilvr.."Seilvr:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Seilvr.."Seilvr:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Seilvr.."Seilvr:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Seilvr.."Seilvr:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Seilvr.."Seilvr:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Seilvr.."Seilvr:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Seilvr.."Seilvr:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Seilvr.."Seilvr:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Seilvr.."Seilvr:Game:Difference"..msg.chat_id) then
if text == Redis:get(Seilvr.."Seilvr:Game:Difference"..msg.chat_id) then 
Redis:del(Seilvr.."Seilvr:Game:Difference"..msg.chat_id)
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Seilvr.."Seilvr:Game:Example"..msg.chat_id) then
if text == Redis:get(Seilvr.."Seilvr:Game:Example"..msg.chat_id) then 
Redis:del(Seilvr.."Seilvr:Game:Example"..msg.chat_id)
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(Seilvr.."Seilvr:All:Get:Reides:Commands:Group"..text) or Redis:get(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
if tonumber(Seilvr) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Seilvr..'Seilvr:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Seilvr.."Seilvr:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Seilvr.."Seilvr:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Seilvr.."Seilvr:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Seilvr.."Seilvr:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Seilvr.."Seilvr:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Seilvr.."Seilvr:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Seilvr) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Seilvr.."Seilvr:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Seilvr.."Seilvr:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Seilvr.."Seilvr:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Seilvr.."Seilvr:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Seilvr.."Seilvr:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf Seilvr.lua')
--download('https://raw.githubusercontent.com/LARICATEAM/Seilvr/main/Seilvr.lua','Seilvr.lua')
...
Redis:del(Seilvr.."Seilvr:SendBcBot") 
...
Redis:set(Seilvr.."Seilvr:SendBcBot",true) 
...
Redis:del(Seilvr.."Seilvr:LeftBot") 
...
Redis:set(Seilvr.."Seilvr:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Seilvr.."Seilvr:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(Seilvr.."Seilvr:AddSudosNew"..msg_chat_id)
...
Redis:set(Seilvr.."Seilvr:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(Seilvr..'Seilvr:ChekBotAdd')  
local UsersBot = Redis:smembers(Seilvr..'Seilvr:Num:User:Pv')  
local Get_Json = '{"BotId": '..Seilvr..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Seilvr.."Seilvr:TheBasics:Group"..v)
local Constructor = Redis:smembers(Seilvr.."Seilvr:Originators:Group"..v)
local Manager = Redis:smembers(Seilvr.."Seilvr:Managers:Group"..v)
local Admin = Redis:smembers(Seilvr.."Seilvr:Addictive:Group"..v)
local Vips = Redis:smembers(Seilvr.."Seilvr:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(Seilvr..'Seilvr:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︙عدد المجموعات : '..(Redis:scard(Seilvr..'Seilvr:ChekBotAdd') or 0)..'\n⌔︙عدد المشتركين : '..(Redis:scard(Seilvr..'Seilvr:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(Seilvr.."Seilvr:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Seilvr..'Seilvr:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Seilvr..'Seilvr:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Seilvr.."Seilvr:ChekBotAdd",msg_chat_id)
Redis:set(Seilvr.."Seilvr:Status:Id"..msg_chat_id,true) ;Redis:set(Seilvr.."Seilvr:Status:Reply"..msg_chat_id,true) ;Redis:set(Seilvr.."Seilvr:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Seilvr.."Seilvr:Status:BanId"..msg_chat_id,true) ;Redis:set(Seilvr.."Seilvr:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Seilvr.."Seilvr:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Seilvr.."Seilvr:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Seilvr.."Seilvr:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Seilvr.."Seilvr:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(Seilvr.."Seilvr:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Seilvr..'Seilvr:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Seilvr..'Seilvr:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(
Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Seilvr.."Seilvr:Status:Welcome"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Status:Id"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Status:Reply"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Status:BanId"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:BotFree") 
...
Redis:del(Seilvr.."Seilvr:TwaslBot") 
...
if Redis:sismember(Seilvr.."Seilvr:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Seilvr.."Seilvr:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Seilvr.."Seilvr:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Seilvr.."Seilvr:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Seilvr.."Seilvr:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Seilvr.."Seilvr:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Seilvr.."Seilvr:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Seilvr.."Seilvr:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Seilvr.."Seilvr:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Seilvr.."Seilvr:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Seilvr.."Seilvr:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Seilvr.."Seilvr:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Seilvr.."Seilvr:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Seilvr.."Seilvr:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Seilvr.."Seilvr:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Seilvr.."Seilvr:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Seilvr.."Seilvr:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Seilvr.."Seilvr:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Seilvr.."Seilvr:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Seilvr.."Seilvr:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Seilvr.."Seilvr:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Seilvr.."Seilvr:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Seilvr.."Seilvr:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Seilvr.."Seilvr:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Seilvr.."Seilvr:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Seilvr.."Seilvr:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Seilvr.."Seilvr:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Seilvr.."Seilvr:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(Seilvr.."Seilvr:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Seilvr.."Seilvr:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Seilvr.."Seilvr:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(Seilvr.."Seilvr:LeftBot") then
...
Redis:set(Seilvr.."Seilvr:Lock:text"..msg_chat_id,true) 
...
Redis:set(Seilvr.."Seilvr:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Seilvr.."Seilvr:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Seilvr.."Seilvr:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Seilvr.."Seilvr:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Seilvr.."Seilvr:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Seilvr.."Seilvr:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Seilvr.."Seilvr:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Seilvr..'Seilvr:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Seilvr.."Seilvr:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Seilvr.."Seilvr:Lock:text"..msg_chat_id)  
...
Redis:del(Seilvr.."Seilvr:Lock:Join"..msg_chat_id)  
...
Redis:del(Seilvr.."Seilvr:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Seilvr.."Seilvr:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Seilvr.."Seilvr:lockpin"..msg_chat_id)  
...
Redis:del(Seilvr.."Seilvr:Lock:edit"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Seilvr..'Seilvr:'..lock..msg_chat_id)    
end
...
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Seilvr.."Seilvr:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Seilvr.."Seilvr:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Link"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Photo"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Video"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Animation"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:geam"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Audio"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:vico"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:forward"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Document"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Contact"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Spam"..msg_chat_id)  
...
Redis:set(Seilvr.."Seilvr:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Seilvr.."Seilvr:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Seilvr.."Seilvr:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Seilvr.."Seilvr:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Seilvr.."Seilvr:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Seilvr.."Seilvr:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(Seilvr.."Seilvr:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Seilvr.."Seilvr:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Seilvr.."Seilvr:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(Seilvr.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Seilvr.."Seilvr:Status:Welcome"..msg_chat_id) then
...
Redis:del(Seilvr.."Seilvr:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Seilvr.."Seilvr:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Seilvr.."Seilvr:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Seilvr.."Seilvr:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Seilvr.."Seilvr:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Seilvr.."Seilvr:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Seilvr.."Seilvr:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Seilvr.."Seilvr:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Seilvr.."Seilvr:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Seilvr.."Seilvr:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Seilvr..'Seilvr:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Seilvr..'Seilvr:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Seilvr.."Seilvr:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Seilvr.."Seilvr:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Seilvr.."Seilvr:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Seilvr.."Seilvr:All:Get:Reides:Commands:Group"..v)
Redis:del(Seilvr.."Seilvr:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Seilvr.."Seilvr:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Seilvr.."Seilvr:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Seilvr.."Seilvr:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Seilvr.."Seilvr:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Seilvr.."Seilvr:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Seilvr.."Seilvr:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(Seilvr.."Seilvr:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(Seilvr.."Seilvr:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Seilvr.."Seilvr:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Seilvr.."Seilvr:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Seilvr.."Seilvr:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Seilvr.."Seilvr:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Seilvr.."Seilvr:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Seilvr.."Seilvr:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Seilvr.."Seilvr:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Seilvr.."Seilvr:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Seilvr.."Seilvr:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Seilvr.."Seilvr:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Seilvr.."Seilvr:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Seilvr..'Seilvr:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Seilvr..'Seilvr:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Seilvr..'Seilvr:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد رسائلك هنا *~ '..(Redis:get(Seilvr..'Seilvr:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد التعديلات هنا *~ '..(Redis:get(Seilvr..'Seilvr:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد جهاتك المضافه هنا *~ '..(Redis:get(Seilvr.."Seilvr:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Seilvr.."Seilvr:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔︙ارسل الان النص
⌔︙يمكنك اضافه :
...
Redis:del(Seilvr.."Seilvr:Set:Id:Groups")
...
Redis:setex(Seilvr.."Seilvr:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔︙ارسل الان النص
⌔︙يمكنك اضافه :
⌔︙`#username` » اسم المستخدم
...
Redis:del(Seilvr.."Seilvr:Set:Id:Group"..msg.chat_id)
...
Redis:del(Seilvr.."Seilvr:DevelopersQ:Groups") 
...
Redis:del(Seilvr.."Seilvr:Developers:Groups") 
...
Redis:del(Seilvr.."Seilvr:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Originators:Group"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Managers:Group"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Addictive:Group"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:BanAll:Groups") 
...
Redis:del(Seilvr.."Seilvr:ktmAll:Groups") 
...
Redis:del(Seilvr.."Seilvr:BanGroup:Group"..msg_chat_id) 
...
Redis:del(Seilvr.."Seilvr:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Seilvr.."Seilvr:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Seilvr.."Seilvr:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Seilvr.."Seilvr:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Seilvr.."Seilvr:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Seilvr.."Seilvr:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Seilvr.."Seilvr:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:Gif"..v)   
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:vico"..v)   
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:stekr"..v)     
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:Text"..v)   
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:Photo"..v)
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:Video"..v)
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:File"..v)
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:Audio"..v)
Redis:del(Seilvr.."Seilvr:Add:Rd:Sudo:video_note"..v)
Redis:del(Seilvr.."Seilvr:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Seilvr.."Seilvr:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Seilvr.."Seilvr:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Seilvr.."Seilvr:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(Seilvr.."Seilvr:SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︙امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/uui9u'}, },}}
...
Redis:setex(Seilvr.."Seilvr:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Seilvr.."Seilvr:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Seilvr.."Seilvr:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Seilvr.."Seilvr:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Seilvr.."Seilvr:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Seilvr..'Seilvr:GetTexting:DevSeilvr'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Seilvr..'Seilvr:Texting:DevSeilvr')
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevSeilvr = Redis:get(Seilvr..'Seilvr:Texting:DevSeilvr')
if TextingDevSeilvr then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevSeilvr,"md",true)  
else
...
if text == "تفعيل تنظيف الميديا" then
Redis:set(Seilvr.."lock_cleaner"..msg_chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id, "✅꒐  تم تفعيل التنظيف الميديا التلقائي ","md",true)
return false
end

if text == "تعطيل تنظيف الميديا" then
DevSeilvr:del(Seilvr.."lock_cleaner"..msg_chat_id)
LuaTele.sendText(msg_chat_id,msg_id,"🔏┇ تم تعطيل » التنظيف التلقائي ","md",true)
return false
end

if text and text:match("^(ضع وقت التنظيف) (%d+)$") then
local NumLoop = tonumber(text:match("(%d+)"))
Redis:set(Seilvr..':Timer_Cleaner:'..msg_chat_id,NumLoop) 
return LuaTele.sendText(msg_chat_id,msg_id,"📡*¦* تم وضع وقت التنظيف » { *"..NumLoop.."* } ساعه","md",true)
end

if text == "مسح الميديا" then 
local mmezz = Redis:get(Seilvr.."Seilvr:cleaner"..msg_chat_id)
if #mmezz == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"📮¦ لا يوجد وسائط مجدوله للحذف \n ","md",true) 
end
for k,v in pairs(mmezz) do DeleteMessage(msg_chat_id, {[0] = v}) end
return LuaTele.sendText(msg_chat_id,msg_id,"📮¦ تم مسح جميع الميديا المجدوله","md",true)
end
end

if msg.Developers then
if msg.content.luatele == "messagePhoto" 
or msg.content.luatele == "messageSticker" 
or msg.content.luatele == "messageVoiceNote" 
or msg.content.luatele == "messageVoice" 
or msg.content.luatele == "messageAudio" 
or msg.content.luatele == "messageVideo" 
or msg.content.luatele == "messageAnimation" 
and Redis:get(Seilvr.."lock_cleaner"..msg_chat_id) then
print("Clener >>> ")
DevSeilvr:sadd(Seilvr.."Seilvr:cleaner"..msg_chat_id,msg.id_)
Timerr = Redis:get(Seilvr..':Timer_Cleaner:'..msg_chat_id)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
Redis:setex(Seilvr..":SetTimerCleaner:"..msg_chat_id..msg.id_,Timerr or 21600,true)  
local Cleaner = Redis:get(Seilvr.."Seilvr:cleaner"..msg_chat_id)
for k,v in pairs(Cleaner) do
if not Redis:get(Seilvr.."Seilvr:cleaner"..msg_chat_id..v) then
DeleteMessage(msg_chat_id, {[0] = v}) 
DevSeilvr:srem(Seilvr.."Seilvr:cleaner"..msg_chat_id,v)
...
Redis:setex(Seilvr.."Seilvr:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Seilvr.."Seilvr:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(Seilvr.."Seilvr:Name:Bot") or "السلطان") then
local NamesBot = (Redis:get(Seilvr.."Seilvr:Name:Bot") or "السلطان")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(Seilvr..'Seilvr:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Seilvr)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⌔︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Seilvr..'Seilvr:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Seilvr..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Seilvr..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Seilvr..'Seilvr:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Seilvr.."Seilvr:Game:Smile"..msg.chat_id,SM)
...
Redis:set(Seilvr.."Seilvr:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Seilvr.."Seilvr:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Seilvr.."Seilvr:Status:Games"..msg.chat_id) then
Redis:del(Seilvr.."Seilvr:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Seilvr.."Seilvr:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Seilvr.."Seilvr:Status:Games"..msg.chat_id) then
Redis:del(Seilvr.."Seilvr:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Seilvr.."Seilvr:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Seilvr.."Seilvr:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Seilvr.."Seilvr:Game:Difference"..msg.chat_id,name)
...
Redis:set(Seilvr.."Seilvr:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Seilvr.."Seilvr:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Seilvr.."Seilvr:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Seilvr.."Seilvr:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Seilvr.."Seilvr:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(Seilvr..'Seilvr:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Seilvr.."Seilvr:Start:Bot") then
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(Seilvr.."Seilvr:Name:Bot") or "السلطان")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Seilvr.."Seilvr:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Seilvr.."Seilvr:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Seilvr.."Seilvr:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(Seilvr.."Seilvr:TwaslBot") and not Redis:sismember(Seilvr.."Seilvr:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Seilvr.."Seilvr:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Seilvr.."Seilvr:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Seilvr..'Seilvr:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Seilvr..'Seilvr:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Seilvr.."Seilvr:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Seilvr..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Seilvr.."Seilvr:List:Manager"..'-100'..data.supergroup.id)
Redis:del(Seilvr.."Seilvr:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Seilvr.."Seilvr:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Seilvr.."Seilvr:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Seilvr) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Seilvr..'Seilvr:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == Seilvr then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Seilvr..'Seilvr:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Seilvr.."Seilvr:Lock:edit"..data.chat_id) then
...
Redis:incrby(Seilvr.."Seilvr:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Seilvr.."Seilvr:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Seilvr.."Seilvr:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Seilvr.."Seilvr:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Seilvr.."Seilvr:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Seilvr.."Seilvr:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Seilvr..'Seilvr:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Seilvr.."Seilvr:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⌔︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Seilvr.."Seilvr:SilentGroup:Group"..ChatId) 
